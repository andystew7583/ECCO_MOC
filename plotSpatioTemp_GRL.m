...
shadedErrorBar(tt_plot,mean(PSI_WS_CRF(1:endIdx,:),2),PSI_WS_err(1:endIdx,:),'lineProps',{'Color',colororder(1,:),'LineWidth',1.5});
hold on
...
shadedErrorBar(tt_plot,-mean(TFS_WS_CRF(1:endIdx,:),2),TFS_WS_err(1:endIdx,:),'lineProps',{'Color',colororder(2,:),'LineWidth',1.5});
shadedErrorBar(tt_plot,-mean(IFS_WS_CRF(1:endIdx,:),2),IFS_WS_err(1:endIdx,:),'lineProps',{'Color',colororder(3,:),'LineWidth',1.5});
shadedErrorBar(tt_plot,-mean(EFS_WS_CRF(1:endIdx,:),2),EFS_WS_err(1:endIdx,:),'lineProps',{'Color',colororder(4,:),'LineWidth',1.5});
...
shadedErrorBar(tt_plot,mean(PSI_WS_CRF_smooth(endIdx+1:end,:),2),PSI_WS_err_smooth(endIdx+1:end,:),'lineProps',{'Color',colororder(1,:),'LineWidth',1.5});
hold on;
...
shadedErrorBar(tt_plot,-mean(TFS_WS_CRF_smooth(endIdx+1:end,:),2),TFS_WS_err_smooth(endIdx+1:end,:),'lineProps',{'Color',colororder(2,:),'LineWidth',1.5});
shadedErrorBar(tt_plot,-mean(IFS_WS_CRF_smooth(endIdx+1:end,:),2),IFS_WS_err_smooth(endIdx+1:end,:),'lineProps',{'Color',colororder(3,:),'LineWidth',1.5});
shadedErrorBar(tt_plot,-mean(EFS_WS_CRF_smooth(endIdx+1:end,:),2),EFS_WS_err_smooth(endIdx+1:end,:),'lineProps',{'Color',colororder(4,:),'LineWidth',1.5});
