%%%
%%% calcIsopFluxSnapshot.m
%%%
%%% Calculates volume fluxes in density bins for a single ECCO output
%%% snapshot. Must be called after potential density has been computed for 
%%% all snapshots.
%%%
%%% Input:
%%%
%%%   n - Iteration number (number of days, starting on Jan 1 1992) 
%%%
function calcIsopFluxSnapshot (n)
